...
public class CodegenDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected CodegenDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (CodegenDslGrammarAccess) access;
