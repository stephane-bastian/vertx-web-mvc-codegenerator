...
@parser::members {
    ...
    public InternalCodegenDslParser(TokenStream input, CodegenDslGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected CodegenDslGrammarAccess getGrammarAccess() {
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getRoutesRouteParserRuleCall_0()); 
	    }
		lv_routes_0_0=ruleRoute		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getRouteAccess().getVerbRouteVerbEnumRuleCall_0_0()); 
	    }
		lv_verb_0_0=ruleRouteVerb		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getRouteAccess().getPathRoutePathParserRuleCall_1_0()); 
	    }
		lv_path_1_0=ruleRoutePath		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRouteRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getRouteAccess().getHandlerRouteHandlerParserRuleCall_2_0()); 
	    }
		lv_handler_2_0=ruleRouteHandler		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRouteRule());
	        }
       		set(
...
entryRuleRoutePath returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getRoutePathRule()); }
	 iv_ruleRoutePath=ruleRoutePath 
	 { $current=$iv_ruleRoutePath.current; } 
	 EOF 
;

// Rule RoutePath
ruleRoutePath returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
(
		...
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getRoutePathRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"value",
...
entryRuleRouteHandler returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getRouteHandlerRule()); }
	 iv_ruleRouteHandler=ruleRouteHandler 
	 { $current=$iv_ruleRouteHandler.current; } 
	 EOF 
;

// Rule RouteHandler
ruleRouteHandler returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getRouteHandlerAccess().getNameRouteHandlerNameParserRuleCall_0_0()); 
	    }
		lv_name_0_0=ruleRouteHandlerName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRouteHandlerRule());
	        }
       		set(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getRouteHandlerAccess().getLeftParenthesisKeyword_1());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getRouteHandlerAccess().getParametersParameterParserRuleCall_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getRouteHandlerAccess().getCommaKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRouteHandlerAccess().getParametersParameterParserRuleCall_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getRouteHandlerAccess().getRightParenthesisKeyword_3());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getParameterAccess().getDefaultValueParameterDefaultValueParserRuleCall_1_0()); 
	    }
		lv_defaultValue_1_0=ruleParameterDefaultValue		{
	        if ($current==null) {
...
entryRuleParameterDefaultValue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getParameterDefaultValueRule()); }
	 iv_ruleParameterDefaultValue=ruleParameterDefaultValue 
	 { $current=$iv_ruleParameterDefaultValue.current; } 
	 EOF 
;

// Rule ParameterDefaultValue
ruleParameterDefaultValue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='=' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getParameterDefaultValueAccess().getEqualsSignKeyword_0());
    }
((
(
		lv_new_1_0=	'new' 
    {
        newLeafNode(lv_new_1_0, grammarAccess.getParameterDefaultValueAccess().getNewNewKeyword_1_0_0());
    }
 
	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getParameterDefaultValueRule());
	        }
...
(
		lv_null_2_0=	'null' 
    {
        newLeafNode(lv_null_2_0, grammarAccess.getParameterDefaultValueAccess().getNullNullKeyword_1_1_0());
    }
...
(
		...
		{
			newLeafNode(lv_value_3_0, grammarAccess.getParameterDefaultValueAccess().getValueSTRINGTerminalRuleCall_1_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getParameterDefaultValueRule());
...
entryRuleRouteHandlerName returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getRouteHandlerNameRule()); } 
	 iv_ruleRouteHandlerName=ruleRouteHandlerName 
	 { $current=$iv_ruleRouteHandlerName.current.getText(); }  
	 EOF 
;

// Rule RouteHandlerName
ruleRouteHandlerName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_ID_0=RULE_ID    {
    ...
    { 
    newLeafNode(this_ID_0, grammarAccess.getRouteHandlerNameAccess().getIDTerminalRuleCall_0()); 
    }
(
	kw='.' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRouteHandlerNameAccess().getFullStopKeyword_1_0()); 
    }
    this_ID_2=RULE_ID    {
    ...
    { 
    newLeafNode(this_ID_2, grammarAccess.getRouteHandlerNameAccess().getIDTerminalRuleCall_1_1()); 
    }
)+)
    ;
...
// Rule RouteVerb
ruleRouteVerb returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='GET' 
	{
        $current = grammarAccess.getRouteVerbAccess().getGETEnumLiteralDeclaration_0().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_0, grammarAccess.getRouteVerbAccess().getGETEnumLiteralDeclaration_0()); 
    }
)
    |(	enumLiteral_1='POST' 
	{
        $current = grammarAccess.getRouteVerbAccess().getPOSTEnumLiteralDeclaration_1().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_1, grammarAccess.getRouteVerbAccess().getPOSTEnumLiteralDeclaration_1()); 
    }
)
    |(	enumLiteral_2='PUT' 
	{
        $current = grammarAccess.getRouteVerbAccess().getPUTEnumLiteralDeclaration_2().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_2, grammarAccess.getRouteVerbAccess().getPUTEnumLiteralDeclaration_2()); 
    }
)
    |(	enumLiteral_3='DELETE' 
	{
        $current = grammarAccess.getRouteVerbAccess().getDELETEEnumLiteralDeclaration_3().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_3, grammarAccess.getRouteVerbAccess().getDELETEEnumLiteralDeclaration_3()); 
    }
)
    |(	enumLiteral_4='HEAD' 
	{
        $current = grammarAccess.getRouteVerbAccess().getHEADEnumLiteralDeclaration_4().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_4, grammarAccess.getRouteVerbAccess().getHEADEnumLiteralDeclaration_4()); 
    }
)
    |(	enumLiteral_5='OPTIONS' 
	{
        $current = grammarAccess.getRouteVerbAccess().getOPTIONSEnumLiteralDeclaration_5().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_5, grammarAccess.getRouteVerbAccess().getOPTIONSEnumLiteralDeclaration_5()); 
    }
));
