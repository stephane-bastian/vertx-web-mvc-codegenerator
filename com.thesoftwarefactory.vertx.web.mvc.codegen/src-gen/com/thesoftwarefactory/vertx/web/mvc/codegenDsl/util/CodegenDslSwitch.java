 ...
 * @generated
 */
public class CodegenDslSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RoutePath routePath = (RoutePath)theEObject;
        T result = caseRoutePath(routePath);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case CodegenDslPackage.ROUTE_HANDLER:
      {
        RouteHandler routeHandler = (RouteHandler)theEObject;
        T result = caseRouteHandler(routeHandler);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        ParameterDefaultValue parameterDefaultValue = (ParameterDefaultValue)theEObject;
        T result = caseParameterDefaultValue(parameterDefaultValue);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Route Path</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Route Path</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRoutePath(RoutePath object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Route Handler</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Route Handler</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRouteHandler(RouteHandler object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Parameter Default Value</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Parameter Default Value</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
