 ...
 * generated by Xtext
 */
package com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr;
...
public class CodegenDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr.internal.InternalCodegenDslParser createParser() {
		com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr.internal.InternalCodegenDslParser result = new com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr.internal.InternalCodegenDslParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getParameterDefaultValueAccess().getAlternatives_1(), "rule__ParameterDefaultValue__Alternatives_1");
					...
					put(grammarAccess.getModelAccess().getRoutesAssignment(), "rule__Model__RoutesAssignment");
					...
					put(grammarAccess.getParameterAccess().getDefaultValueAssignment_1(), "rule__Parameter__DefaultValueAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr.internal.InternalCodegenDslParser typedParser = (com.thesoftwarefactory.vertx.web.mvc.ui.contentassist.antlr.internal.InternalCodegenDslParser) parser;
